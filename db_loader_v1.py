...
class Session(Base):
    ...
    session_weather = relationship("Weather", foreign_keys=('Weather.session_id'), back_populates="weather_session")
...
class DriverTeamAssignment(Base):
    ...
    dta_lap = relationship("Lap", foreign_keys=('Lap.driver_team_assignment_id'),back_populates="lap_dta")
